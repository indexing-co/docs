...
This renders a live, colorized stream of events as they flow through your pipeline:

```
╭──────────────────────────────────────────────────╮
│  ◆ INDEXING.CO — Live Event Stream               │
│                                                  │
│  Channel:  my-usdc-transfers                     │
╰──────────────────────────────────────────────────╯
...
── #1 ──────────────────────────── 14:32:07.123 ──
  chain              BASE
  block              28419523
  transaction_hash   0x3a9f...c2d1
  from_address       0x7a25...f091
  to_address         0xdead...beef
  value              1000000
```

Addresses show in magenta, transaction hashes in blue, numbers in yellow, and nested objects are indented with recursive colorization. Press Ctrl+C to see a summary with total event count, duration, and average throughput.
