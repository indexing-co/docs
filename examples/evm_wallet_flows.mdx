...
🔑 To get started, you’ll need an API key. You can request access at [indexing.co/contact](https://indexing.co/contact) or by emailing us at [hello@indexing.co](mailto:hello@indexing.co).
...
To run these pipelines you can [contact us](https://indexing.co/contact) to get your API key.
